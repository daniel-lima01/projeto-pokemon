/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
        - passo 6 - verificar se o body já tem  classe do modo-escuro 
...
const imagemBotaoTrocaDeImagem = document.querySelector(".imagem-botao")
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if(modoEscuroEstaAtivo) {
     imagemBotaoTrocaDeImagem.setAttribute("src", "./src/imagens/sun.png");

     } else { 
        imagemBotaoTrocaDeImagem.setAttribute("src", "./src/imagens/moon.png");
    }
});